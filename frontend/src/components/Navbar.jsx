      ...
      <header className="flex  w-full items-center py-4 border-b-2 z-10 fixed bg-[#ffffff] md:justify-between md:px-20">
        <div className="flex justify-between sm:container">
          ...
          >
            ...
            <span className="text-[#FF385C] font-bold ">airbnb</span>
          </Link>
          {/* search box */}
          <div className="inputcontainer inline-flex justify-center items-center border shadow-sm border-gray-200 rounded-full py-2 gap-3 px-6 font-semibold cursor-pointer hover:shadow-md md:ml-36 sm:ml-16 md:w-auto sm:absolute md:static sm:w-4/5">
            <div className="anywhere text-lg">Anywhere</div>
            <div className="border-l border-gray-300 h-8"></div>
            <div className="anywhere text-lg">Any week</div>
            <div className="border-l border-gray-400 h-8"></div>
            <div className="anywhere  text-gray-500 text-lg">Add guests</div>
            <div className="bg-[#FF385C] rounded-full p-1 text-white font-semibold">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
          ...
          <div className="profile flex flex-row gap-3 items-center justify-between cursor-pointer sm:text-center sm:invisible md:visible">
            ...
            >
              ...
              {!auth?.user ? (
                ...
                <div className="bg-[#FF385C] text-white px-2 py-1 mr-0 font-semibold rounded-full flex items-center w-40 justify-center">
                  {auth?.user?.name}
                </div>
              )}
            </div>
